...
#define S(mg, eg) make_score(mg, eg)
  ...
  constexpr Score RookPawnBlockade    = S( 16,  5);
  ...
  Score Evaluation<T>::passed() const {
    ...
    while (b)
    {
        ...
        if (r > RANK_3)
        {
            ...
            {
            	if (pos.pieces(Them, ROOK) & ~(pe->pawn_attacks_span(Us) | (attackedBy[Us  ][KNIGHT] | attackedBy[Us  ][BISHOP])) & blockSq)
            	    score -= RookPawnBlockade;
            }
        } // r > RANK_3
