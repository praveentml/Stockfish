...
#define S(mg, eg) make_score(mg, eg)
  ...
  Score RestrictedPiece[PIECE_TYPE_NB] = {
    S(7, 7), S(15, 15), S(20, 20), S(40, 40), S(70, 70), S(70, 70)
  };
...
#undef S
  ...
  Score Evaluation<T>::threats() const {
    ...
    while (b)
    	score += RestrictedPiece[type_of(pos.piece_on(pop_lsb(&b)))];
